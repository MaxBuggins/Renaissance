    ...
    public struct GameActions
    {
        ...
        public void SetCallbacks(IGameActions instance)
        {
            if (m_Wrapper.m_GameActionsCallbackInterface != null)
            {
                ...
                @ShowScore.started -= m_Wrapper.m_GameActionsCallbackInterface.OnShowScore;
                @ShowScore.performed -= m_Wrapper.m_GameActionsCallbackInterface.OnShowScore;
                @ShowScore.canceled -= m_Wrapper.m_GameActionsCallbackInterface.OnShowScore;
            }
